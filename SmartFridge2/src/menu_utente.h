/**
 * @def MENU_UTENTE_H_
 * @brief contiene i sottoprammi che permettono l'interazione dell'utente con le varie funzionalità del programma
 */
 ...
 * @brief richiede all'utente un alimento presente nel file alimenti e glielo mostra
 */
