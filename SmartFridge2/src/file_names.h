 ...
 * è il file in cui vengono memorizzati ed aggiornati gli alimenti presenti in frigo
 */
 ...
 * è il file in cui vengono memorizzate ed aggiornate le ricette presenti nel ricettario
 */
 ...
 * @brief file binario di tipo t_ricetta
 * è il file in cui vengono memorizzate le ricette preparate in ordine cronologico
 */
 ...
 * @warning il primo elemento indica il giorno corrente ed è di tipo t_giorno
